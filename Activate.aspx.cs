...
public partial class Activate : System.Web.UI.Page
{
    ...
    private void changestatus()
    {
        ...
        String updatedata = "Update register set Status='Verified' where emailid='" + Request.QueryString["emailadd"] + "'";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        String mycon = "Data Source=DESKTOP-82J91LH;Initial Catalog=ShoppingData;Integrated Security=True";
 String myquery = "Select * from register where emailid='" + Request.QueryString["emailadd"] + "'";
        SqlConnection con = new SqlConnection(mycon);
        SqlCommand cmd = new SqlCommand();
