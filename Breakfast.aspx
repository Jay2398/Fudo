<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage3.master" AutoEventWireup="true" CodeFile="Breakfast.aspx.cs" Inherits="Breakfast" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div style="text-align: center">
        ...
        <br />
        <br />
        <asp:Label ID="Label2" runat="server" Text="WELCOME TO FUDO BREAKFAST ORDER" 
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <asp:DataList ID="DataList1" runat="server" BorderColor="#999999" 
            ...
            RepeatDirection="Horizontal" Width="851px" BackColor="#CCCCCC" 
            ForeColor="Black">
                    ...
                    <tr>
                        <td style="text-align: center">
                            <asp:ImageButton ID="ImageButton1" runat="server" 
                                CommandArgument='<%# Eval("foodid")%>' CommandName="addtocart" Height="55px" 
                                ImageUrl="~/images/addtocart.png" Width="148px" 
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT * FROM [BreakfastCart]"></asp:SqlDataSource>
        <br />
</div>
